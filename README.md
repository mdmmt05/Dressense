...
├── db\_manager.py       # SQLite abstraction, garment CRUD, weights management

├── outfit\_engine.py    # Outfit generation and scoring logic

├── feedback\_engine.py  # Adaptive Preference Engine

└── color\_utils.py      # Color conversion utilities (CSS → RGB → CIELab)
